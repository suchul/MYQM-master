...
public class SettingButtonsActivity extends AppCompatActivity implements
        View.OnClickListener,
        App.BlutoothListener {

    private final static String TAG = SettingButtonsActivity.class.getSimpleName(); // 디버그 태그
                ...
                case FIRMWARE_INFORMATION:
                    ...
                    if (result == Result.SUCCESS) {
                        if (null != byteArray
                            ...
                            if (isSave) {
                                ToastUtil.getInstance().show(SettingButtonsActivity.this, getResources().getString(R.string.saved), false);
                                isSave = false;
                            }
...
//        }
    ...
    public void onResume() {
        ...
        // UART 리스너 해제
        App.getInstance().setBlutoothListener(null, SettingButtonsActivity.this);
        // BLE 리스너 등록
        App.getInstance().setBlutoothListener(this, SettingButtonsActivity.this);
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.activity_setting_patch_tv_resolution_synchronization_start:
                ...
                if (tempResolution == screenResolution) {
                    ToastUtil.getInstance().show(SettingButtonsActivity.this, getResources().getString(R.string.saved_resolution_already), false);
                    return;
                }
...
//        }
        ...
        if (Definition.RESPONSE_COMMAND_WRITE_USER_SETTING.equals(command)) {
            if (isResolutionSynchronization) {
                ...
                ToastUtil.getInstance().show(SettingButtonsActivity.this, getResources().getString(R.string.saved_resolution), false);
            } else {
                // 임시데이터에 데이터 저장
                arrayTemp = arrayData;
                if (checkChangData()) {
...
//        }
    ...
    private void goToSelectDeviceActivity() {
        ...
        Intent intent = new Intent(SettingButtonsActivity.this, SelectDeviceActivity.class);
