...
public class HotKeyBLongActivity extends Activity {
    private final static String TAG = HotKeyBLongActivity.class.getSimpleName();   // 디버그 태그
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_home);
        LogUtil.i(TAG, "onCreate() -> Start !!!");
        int vendorCode = PreferencesUtil.getInstance(HotKeyBLongActivity.this).getVendorCode();
        ...
        if (vendorCode > 0
            ...
            switch(vendorCode) {
                case 1:
                    boolean success = PackageUtil.executeApp(HotKeyBLongActivity.this, "com.itvers.toolbox");
            ...
            HashMap<String, String> hashMap = PreferencesUtil.getInstance(HotKeyBLongActivity.this).getBkeyLong();
                ...
                switch (Key.valueOf(type)) {
                    ...
                    case APP: {
                        if (StringUtil.isNotNull(packageName)
                            ...
                            boolean success = PackageUtil.executeApp(HotKeyBLongActivity.this, packageName);
                            LogUtil.d(TAG, "onCreate() -> executeApp: " + success);
                        }
                    }
                    break;
                        ...
                        if (!list.isEmpty()) {
                            for (ResolveInfo resolveInfo : list) {
                                ...
                                if (!defaultEmailPackageName.equalsIgnoreCase(getApplicationContext().getPackageName())) {
                                    boolean success = PackageUtil.executeApp(HotKeyBLongActivity.this, defaultEmailPackageName);
                                    LogUtil.d(TAG, "onCreate() -> executeApp: " + success);
                                }
                            }
                        }
