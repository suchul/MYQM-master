...
public class SettingPatchActivity extends AppCompatActivity implements
        View.OnClickListener,
        App.BlutoothListener {

    private final static String TAG = SettingPatchActivity.class.getSimpleName();   // 디버그 태그
    ...
    private String bKeyDouble = "1";
    private String bKeyLong = "1";
    private String cKeyDouble = "1";
    private String cKeyLong = "1";
...
//                            tempByteArray = App.getInstance().getFirmwareInformationData();
                            ...
                            if (isSave) {
                                ToastUtil.getInstance().show(SettingPatchActivity.this, getResources().getString(R.string.saved), false);
                                isSave = false;
                            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_patch);
        ...
        // 클릭 리스너 등록
        findViewById(R.id.activity_setting_patch_ll_back).setOnClickListener(this);                             // 뒤로가기 버튼
        findViewById(R.id.activity_setting_patch_ibtn_os_on_off).setOnClickListener(this);                      // OS 스위치 버튼
        findViewById(R.id.activity_setting_patch_rb_mouse).setOnClickListener(this);                            // 마우스 모드 라디오 버튼
        findViewById(R.id.activity_setting_patch_rb_wheel).setOnClickListener(this);                            // 휠 모드 라디오 버튼
        findViewById(R.id.activity_setting_patch_rb_keyboard).setOnClickListener(this);                         // 키보드 모드 라디오 버튼
        findViewById(R.id.activity_setting_patch_ibtn_direction_on_off).setOnClickListener(this);               // 사용방향 스위치 버튼
        findViewById(R.id.activity_setting_patch_rb_poiner_speed_very_slow).setOnClickListener(this);           // 매우 느림 라디오 버튼
        findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow).setOnClickListener(this);                // 느림 라디오 버튼
        findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal).setOnClickListener(this);              // 보통 라디오 버튼
        findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast).setOnClickListener(this);                // 빠름 라디오 버튼
        findViewById(R.id.activity_setting_patch_tv_resolution_synchronization_start).setOnClickListener(this); // 해상도 동기화 시작 버튼
        findViewById(R.id.activity_setting_patch_tv_resolution_synchronization_start).setEnabled(false);
        findViewById(R.id.activity_setting_patch_tv_save_change).setOnClickListener(this);                      // 저장 및 변경 버튼
        findViewById(R.id.activity_setting_patch_tv_save_change).setEnabled(false);
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case MSG_CHANGE_WHITE:
                        ((TextView) findViewById(R.id.activity_setting_patch_tv_save_change)).setTextColor(getResources().getColor(R.color.colorWhite));
                        textChangeHandler.sendMessageDelayed(textChangeHandler.obtainMessage(MSG_CHANGE_RED), 500);
                        break;
                    case MSG_CHANGE_RED:
                        ((TextView) findViewById(R.id.activity_setting_patch_tv_save_change)).setTextColor(getResources().getColor(R.color.colorRed));
        ...
        // 뷰 설정
        LogUtil.e(TAG, "setView() @ onCreate()!!!");
        setView();
    }
    ...
    public void onResume() {
        ...
        // UART 리스너 해제
        App.getInstance().setBlutoothListener(null, SettingPatchActivity.this);
        // BLE 리스너 등록
        App.getInstance().setBlutoothListener(this, SettingPatchActivity.this);
    }
...
//        super.onBackPressed();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            // 기기선택 버튼
            case R.id.activity_setting_patch_ll_back:
                if (checkChangData()
                        && null != App.getInstance().getUARTService()) {
                    Dialog.getInstance().showDual(
                            this,
                ...
                break;
            // OS 스위치 버튼
            case R.id.activity_setting_patch_ibtn_os_on_off:
                LogUtil.d(TAG, "onClick() -> os : " + os);
                LogUtil.d(TAG, "onClick() -> isSelected : " + findViewById(R.id.activity_setting_patch_ibtn_os_on_off).isSelected());
                if (findViewById(R.id.activity_setting_patch_ibtn_os_on_off).isSelected()) {
                    findViewById(R.id.activity_setting_patch_ibtn_os_on_off).setSelected(false);
                    ((ImageView) findViewById(R.id.activity_setting_patch_ibtn_os_on_off)).setImageResource(R.drawable.sw_off);
                    os = Definition.IOS;

                    //Steve_20191230 변수 -> 임시변수
                    //valueToTemp();
                } else {
                    findViewById(R.id.activity_setting_patch_ibtn_os_on_off).setSelected(true);
                    ((ImageView) findViewById(R.id.activity_setting_patch_ibtn_os_on_off)).setImageResource(R.drawable.sw_on);
                    os = Definition.ANDROID;

                    //Steve_20191230 임시변수 -> 변수
                    //tempToValue();
                }
                LogUtil.e(TAG, "setView() @ onClick() -> activity_setting_patch_ibtn_os_on_off!!!");
                setView();

                break;
            // 키보드 모드 라디오 버튼
            case R.id.activity_setting_patch_rb_keyboard:
                if (((RadioButton) findViewById(R.id.activity_setting_patch_rb_keyboard)).isChecked()) {
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_mouse)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_wheel)).setChecked(false);
                    mode = Definition.KEYBOARD_MODE;
                    wheelMode = Definition.MOUSE_CURSOR;
                    setViewMode();
                    break;
                }
                findViewById(R.id.activity_setting_patch_rb_wheel).setEnabled(true);
                setViewMode();
                break;
            // 마우스 모드 라디오 버튼
            case R.id.activity_setting_patch_rb_mouse:
                if (((RadioButton) findViewById(R.id.activity_setting_patch_rb_mouse)).isChecked()) {
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_keyboard)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_wheel)).setChecked(false);
                ...
                findViewById(R.id.activity_setting_patch_rb_mouse).setEnabled(true);
                setViewMode();
                break;
            // 휠 모드 라디오 버튼
            case R.id.activity_setting_patch_rb_wheel:
                if (((RadioButton) findViewById(R.id.activity_setting_patch_rb_wheel)).isChecked()) {
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_keyboard)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_mouse)).setChecked(false);
                    mode = Definition.MOUSE_MODE;
                ...
                break;
            // 사용방향 스위치 버튼
            case R.id.activity_setting_patch_ibtn_direction_on_off:
                if (findViewById(R.id.activity_setting_patch_ibtn_direction_on_off).isSelected()) {
                    findViewById(R.id.activity_setting_patch_ibtn_direction_on_off).setSelected(false);
                    ((ImageView) findViewById(R.id.activity_setting_patch_ibtn_direction_on_off))
                            .setImageResource(R.drawable.sw_off);
                    lr = Definition.LR_NORMAL;
                } else {
                    findViewById(R.id.activity_setting_patch_ibtn_direction_on_off).setSelected(true);
                    ((ImageView) findViewById(R.id.activity_setting_patch_ibtn_direction_on_off))
                ...
                break;
            // 매우 느림 라디오 버튼
            case R.id.activity_setting_patch_rb_poiner_speed_very_slow:
                if (((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_very_slow)).isChecked()) {
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast)).setChecked(false);
                    sensitive = Definition.MMV_DULL;
                    setViewsensitive();
                    break;
                }
                findViewById(R.id.activity_setting_patch_rb_poiner_speed_very_slow).setEnabled(true);
                setViewsensitive();
                break;

            // 느림 라디오 버튼
            case R.id.activity_setting_patch_rb_poiner_speed_slow:
                if (((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow)).isChecked()) {
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_very_slow)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast)).setChecked(false);
                ...
                findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow).setEnabled(true);
                setViewsensitive();
                break;
            // 보통 라디오 버튼
            case R.id.activity_setting_patch_rb_poiner_speed_normal:
                if (((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal)).isChecked()) {
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_very_slow)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast)).setChecked(false);
                ...
                findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal).setEnabled(true);
                setViewsensitive();
                break;
            // 빠름 라디오 버튼
            case R.id.activity_setting_patch_rb_poiner_speed_fast:
                if (((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast)).isChecked()) {
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_very_slow)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow)).setChecked(false);
                    ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal)).setChecked(false);
                ...
                findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast).setEnabled(true);
                setViewsensitive();
                break;
            // 해상도 동기화 시작 버튼
            case R.id.activity_setting_patch_tv_resolution_synchronization_start:
                String[] temp = screenValue();
                int tempResolution = ParserUtil.getScreenResolution(temp);
                if (tempResolution == screenResolution) {
                    ToastUtil.getInstance().show(SettingPatchActivity.this, getResources().getString(R.string.saved_resolution_already), false);
                    return;
                }
                screenResolution = tempResolution;
                LogUtil.d(TAG, "OnClickPositive() -> screenResolution : " + screenResolution);
                ((TextView) findViewById(R.id.activity_setting_patch_tv_resolution_synchronization_start)).setText(ParserUtil.getResolutionDisplay(screenResolution));
                break;
            // 저장 및 변경 버튼
            case R.id.activity_setting_patch_tv_save_change:
                if (checkChangData()) {
...
//        }
        ...
        if (Definition.RESPONSE_COMMAND_FIRMWARE_INFORMATION.equals(command)) {
            ...
            // TODO 테스트
//            binary = "1111001000000000000000011001";
//            LogUtil.d(TAG, "parseUserSettingData() -> binary : " + binary + ", length : " + binary.length());

            String[] tempBody = ParserUtil.getSettingData(binary);
            if (null == tempBody) {
            ...
            String[] arrBody = new String[32];
            for (int i=0; i<arrBody.length; i ++) {
                arrBody[i] = "0";
            }

            LogUtil.d(TAG, "parseUserSettingData() -> tempBody : " + tempBody + ", length : " + tempBody.length);
            if (Definition.TOTAL_DATA_SETTING_BINARY_LENGTH != tempBody.length) {
                if (tempBody.length < 28) {
                ...
                for (int i=4; i<arrBody.length; i ++) {
                    arrBody[i] = tempBody[i-4];
                }
            } else {
                arrBody = tempBody;
            }
...
//            LogUtil.d(TAG, "parseUserSettingData() -> reserved : " + reserved);
            ...
            LogUtil.d(TAG, "parseUserSettingData() -> bKeyDouble : " + temp[0]);

            temp = new String[1];
            temp[0] = arrayData[Definition.INDEX_RESERVED_6];
            LogUtil.d(TAG, "parseUserSettingData() -> bKeyLong : " + temp[0]);

            temp = new String[1];
            temp[0] = arrayData[Definition.INDEX_RESERVED_7];
            LogUtil.d(TAG, "parseUserSettingData() -> cKeyDouble : " + temp[0]);

            temp = new String[1];
            temp[0] = arrayData[Definition.INDEX_RESERVED_8];
            LogUtil.d(TAG, "parseUserSettingData() -> cKeyLong : " + temp[0]);
            ...
            LogUtil.d(TAG, "parseUserSettingData() -> screenResolution : " + screenResolution);
            ...
            findViewById(R.id.activity_setting_patch_tv_resolution_synchronization_start).setEnabled(true);
            findViewById(R.id.activity_setting_patch_tv_save_change).setEnabled(true);

            if (isSavedFinish) isSavedFinish = false;

            // 뷰 설정
            LogUtil.e(TAG, "setView() @ parseUserSettingData() -> parseUserSettingData()!!!");
            setView();
...
//        }
        ...
        if (Definition.RESPONSE_COMMAND_WRITE_USER_SETTING.equals(command)) {
            if (isResolutionSynchronization) {
                ...
                ((TextView) findViewById(R.id.activity_setting_patch_tv_resolution_synchronization_start)).setText(ParserUtil.getResolutionDisplay(ParserUtil.getScreenResolution(screenValue())));
                ToastUtil.getInstance().show(SettingPatchActivity.this, getResources().getString(R.string.saved_resolution), false);
            } else {
                // 임시데이터에 데이터 저장
                arrayTemp = arrayData;
                if (checkChangData()) {
    ...
    private byte[] getUserSettingValue() {
        ...
        // 타겟 OS
        String[] arrTargetOS = ParserUtil.getTargetOS(targetOS);
...
//        }
    ...
    private void setViewOS() {
        ...
        LogUtil.d(TAG, "setViewOS() -> os : " + os);

        switch (os) {
            case Definition.ANDROID: {  // 안드로이드
                // 안드로이드 애니매이션 시작
                findViewById(R.id.activity_setting_patch_iv_android).setBackgroundResource(R.drawable.animation_icon_android);
                animationAndroid = ( AnimationDrawable ) findViewById(R.id.activity_setting_patch_iv_android).getBackground();
                animationAndroid.start();

                // iOS 애니메이션 중지
                if (null != animationiOS) animationiOS.stop();
                findViewById(R.id.activity_setting_patch_iv_ios).setBackgroundResource(R.drawable.ic_ios1);
            }
            break;
            case Definition.IOS: {      // iOS
                // iOS 애니매이션 시작
                findViewById(R.id.activity_setting_patch_iv_ios).setBackgroundResource(R.drawable.animation_icon_ios);
                animationiOS = ( AnimationDrawable ) findViewById(R.id.activity_setting_patch_iv_ios).getBackground();
                animationiOS.start();

                // 안드로이드 애니메이션 중지
                if (null != animationAndroid) animationAndroid.stop();
                findViewById(R.id.activity_setting_patch_iv_android).setBackgroundResource(R.drawable.ic_android1);
            }
            break;
            default: {                  // 기본 뷰
                findViewById(R.id.activity_setting_patch_iv_android).setBackgroundResource(R.drawable.ic_android1);
    ...
    private void setViewMode() {
        ...
        LogUtil.d(TAG, "setViewMode() -> mode : " + mode);
        ...
        switch (mode) {
            case Definition.KEYBOARD_MODE: {    // 키보드 모드
                // 키보드 모드 애니메이션 시작
                findViewById(R.id.activity_setting_patch_iv_keyboard).setBackgroundResource(R.drawable.animation_icon_keyboard);
                animationKeyboard = ( AnimationDrawable ) findViewById(R.id.activity_setting_patch_iv_keyboard).getBackground();
                animationKeyboard.start();
                // 키보드 모드 텍스트 변경
                ((TextView) findViewById(R.id.activity_setting_patch_tv_keyboard)).setTypeface(bold);

                // 휠 모드 애니메이션 중지
                if (null != animationWheel) animationWheel.stop();
                findViewById(R.id.activity_setting_patch_iv_wheel).setBackgroundResource(R.drawable.ic_wheel1);
                // 휠 모드 텍스트 변경
                ((TextView) findViewById(R.id.activity_setting_patch_tv_wheel)).setTypeface(normal);

                // 마우스 모드 애니메이션 중지
                if (null != animationMouse) animationMouse.stop();
                findViewById(R.id.activity_setting_patch_iv_mouse).setBackgroundResource(R.drawable.ic_mouse1);
                // 마우스 모드 텍스트 변경
                ((TextView) findViewById(R.id.activity_setting_patch_tv_mouse)).setTypeface(normal);
            }
            break;
            case Definition.MOUSE_MODE: {       // 마우스 모드
                switch(wheelMode) {
                    case Definition.MOUSE_WHEEL: {  // 휠 모드
                        // 휠 모드 애니메이션 시작
                        findViewById(R.id.activity_setting_patch_iv_wheel).setBackgroundResource(R.drawable.animation_icon_wheel);
                        animationWheel = (AnimationDrawable) findViewById(R.id.activity_setting_patch_iv_wheel).getBackground();
                        animationWheel.start();
                        // 휠 모드 텍스트 변경
                        ((TextView) findViewById(R.id.activity_setting_patch_tv_wheel)).setTypeface(bold);
                        ...
                        findViewById(R.id.activity_setting_patch_iv_keyboard).setBackgroundResource(R.drawable.ic_keyboard1);
                        // 키보드 모드 텍스트 변경
                        ((TextView) findViewById(R.id.activity_setting_patch_tv_keyboard)).setTypeface(normal);
                    }
                        break;
                    default: {
                        // 마우스 모드 애니메이션 시작
                        findViewById(R.id.activity_setting_patch_iv_mouse).setBackgroundResource(R.drawable.animation_icon_mouse);
                        animationMouse = (AnimationDrawable) findViewById(R.id.activity_setting_patch_iv_mouse).getBackground();
                        animationMouse.start();
                        // 키보드 모드 텍스트 변경
                        ((TextView) findViewById(R.id.activity_setting_patch_tv_mouse)).setTypeface(bold);
    ...
    private void setViewlr() {
        ...
        LogUtil.d(TAG, "setViewlr() -> lr : " + lr);
		
        switch (lr) {
            case Definition.LR_REVERSE: {   // 사용방향 반전
                // 사용방향 검지 애니매이션 시작
                findViewById(R.id.activity_setting_patch_iv_index_finger).setBackgroundResource(R.drawable.animation_icon_index_finger);
                animationIndexFinger = ( AnimationDrawable ) findViewById(R.id.activity_setting_patch_iv_index_finger).getBackground();
                animationIndexFinger.start();

                // 사용방향 엄지 애니메이션 중지
                if (null != animationThumb) animationThumb.stop();
                findViewById(R.id.activity_setting_patch_iv_thumb).setBackgroundResource(R.drawable.ic_thumb);
            }
            break;
            case Definition.LR_NORMAL: {    // 사용방향 보통
                // 사용방향 엄지 애니매이션 시작
                findViewById(R.id.activity_setting_patch_iv_thumb).setBackgroundResource(R.drawable.animation_icon_thumb);
                animationThumb = ( AnimationDrawable ) findViewById(R.id.activity_setting_patch_iv_thumb).getBackground();
                animationThumb.start();

                // 사용방향 검지 애니메이션 중지
                if (null != animationIndexFinger) animationIndexFinger.stop();
                findViewById(R.id.activity_setting_patch_iv_index_finger).setBackgroundResource(R.drawable.ic_index_finger);
            }
            break;
            default: {                      // 기본 뷰
                findViewById(R.id.activity_setting_patch_iv_index_finger).setBackgroundResource(R.drawable.ic_index_finger);
    ...
    private void setViewsensitive() {
        ...
        LogUtil.d(TAG, "setViewsensitive() -> sensitive : " + sensitive);
        ...
        switch (sensitive) {
            case Definition.MMV_SENSITIVE_1: {   // 느림
                // 느림 텍스트 변경
                ((TextView) findViewById(R.id.activity_setting_patch_tv_poiner_speed_slow)).setTypeface(bold);
                // 보통 텍스트 변경
                ((TextView) findViewById(R.id.activity_setting_patch_tv_poiner_speed_normal)).setTypeface(normal);
                // 빠름 텍스트 변경
                ((TextView) findViewById(R.id.activity_setting_patch_tv_poiner_speed_fast)).setTypeface(normal);
            }
            break;
            case Definition.MMV_SENSITIVE_2: { // 보통
                // 느림 텍스트 변경
                ((TextView) findViewById(R.id.activity_setting_patch_tv_poiner_speed_slow)).setTypeface(normal);
                // 보통 텍스트 변경
                ((TextView) findViewById(R.id.activity_setting_patch_tv_poiner_speed_normal)).setTypeface(bold);
                // 빠름 텍스트 변경
                ((TextView) findViewById(R.id.activity_setting_patch_tv_poiner_speed_fast)).setTypeface(normal);
            }
            break;
            case Definition.MMV_SENSITIVE_3: {   // 빠름
                ...
                ((TextView) findViewById(R.id.activity_setting_patch_tv_poiner_speed_normal)).setTypeface(normal);
                // 빠름 텍스트 변경
                ((TextView) findViewById(R.id.activity_setting_patch_tv_poiner_speed_fast)).setTypeface(bold);
            }
            break;
            default: {                              // 기본 뷰
                // 느림 텍스트 변경
    ...
    private void setSwitchOS() {
        ...
        switch (os) {
            case Definition.ANDROID: {  // 안드로이드
                findViewById(R.id.activity_setting_patch_ibtn_os_on_off).setSelected(true);
                findViewById(R.id.activity_setting_patch_ibtn_os_on_off).setEnabled(true);
                ((ImageView) findViewById(R.id.activity_setting_patch_ibtn_os_on_off)).setImageResource(R.drawable.sw_on);
            }
            break;
            case Definition.IOS: {      // iOS
            ...
            break;
            default: {                  // 기본 뷰
                ((ImageView) findViewById(R.id.activity_setting_patch_ibtn_os_on_off)).setImageResource(R.drawable.sw_disable_off);
                findViewById(R.id.activity_setting_patch_ibtn_os_on_off).setEnabled(false);
            }
            break;
        }
    }
    ...
    private void setRadioMode() {
        ...
        switch (mode) {
            case Definition.KEYBOARD_MODE: {        // 키보드 모드
                findViewById(R.id.activity_setting_patch_rb_keyboard).setEnabled(true);
                findViewById(R.id.activity_setting_patch_rb_mouse).setEnabled(true);
                findViewById(R.id.activity_setting_patch_rb_wheel).setEnabled(true);

                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_keyboard)).setChecked(true);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_mouse)).setChecked(false);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_wheel)).setChecked(false);
            }
            break;
            case Definition.MOUSE_MODE: {           // 마우스 모드
                switch(wheelMode) {
                    case Definition.MOUSE_WHEEL: {  // 휠 모드
                        ...
                        ((RadioButton) findViewById(R.id.activity_setting_patch_rb_keyboard)).setChecked(false);
                        ((RadioButton) findViewById(R.id.activity_setting_patch_rb_mouse)).setChecked(false);
                        ((RadioButton) findViewById(R.id.activity_setting_patch_rb_wheel)).setChecked(true);
                    }
                        break;
                    default: {                      // 마우스 모드
                        findViewById(R.id.activity_setting_patch_rb_keyboard).setEnabled(true);
                        ...
                        ((RadioButton) findViewById(R.id.activity_setting_patch_rb_keyboard)).setChecked(false);
                        ((RadioButton) findViewById(R.id.activity_setting_patch_rb_mouse)).setChecked(true);
                        ((RadioButton) findViewById(R.id.activity_setting_patch_rb_wheel)).setChecked(false);
                    }
                        break;
                }
            ...
            default: {                              // 기본 뷰
                ...
                findViewById(R.id.activity_setting_patch_rb_keyboard).setEnabled(false);
                findViewById(R.id.activity_setting_patch_rb_mouse).setEnabled(false);
                findViewById(R.id.activity_setting_patch_rb_wheel).setEnabled(false);
            }
            break;
        }
    }
    ...
    private void setSwitchLR() {
        ...
        switch (lr) {
            case Definition.LR_REVERSE: {
                findViewById(R.id.activity_setting_patch_ibtn_direction_on_off).setSelected(true);
                findViewById(R.id.activity_setting_patch_ibtn_direction_on_off).setEnabled(true);
                ((ImageView) findViewById(R.id.activity_setting_patch_ibtn_direction_on_off)).setImageResource(R.drawable.sw_on);
            }
            break;
            case Definition.LR_NORMAL: {
                findViewById(R.id.activity_setting_patch_ibtn_direction_on_off).setSelected(false);
                findViewById(R.id.activity_setting_patch_ibtn_direction_on_off).setEnabled(true);
                ((ImageView) findViewById(R.id.activity_setting_patch_ibtn_direction_on_off)).setImageResource(R.drawable.sw_off);
            }
            break;
            default:
                ((ImageView) findViewById(R.id.activity_setting_patch_ibtn_direction_on_off)).setImageResource(R.drawable.sw_disable_off);
                findViewById(R.id.activity_setting_patch_ibtn_direction_on_off).setEnabled(false);
                break;
        }
    }
    ...
    private void setRadiosensitive() {
        ...
        switch (sensitive) {
            case Definition.MMV_DULL: {   // 매우 느림
                ...
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_very_slow)).setChecked(true);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow)).setChecked(false);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal)).setChecked(false);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast)).setChecked(false);
            }
            ...
            case Definition.MMV_SENSITIVE_1: {   // 느림
                ...
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_very_slow)).setChecked(false);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow)).setChecked(true);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal)).setChecked(false);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast)).setChecked(false);
            }
            break;
            case Definition.MMV_SENSITIVE_2: { // 보통
                ...
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_very_slow)).setChecked(false);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow)).setChecked(false);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal)).setChecked(true);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast)).setChecked(false);
            }
            break;
            case Definition.MMV_SENSITIVE_3: {   // 빠름
                ...
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow)).setChecked(false);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal)).setChecked(false);
                ((RadioButton) findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast)).setChecked(true);
            }
            break;
            default: {                              // 기본 뷰
                findViewById(R.id.activity_setting_patch_rb_poiner_speed_very_slow).setEnabled(false);
                findViewById(R.id.activity_setting_patch_rb_poiner_speed_slow).setEnabled(false);
                findViewById(R.id.activity_setting_patch_rb_poiner_speed_normal).setEnabled(false);
                findViewById(R.id.activity_setting_patch_rb_poiner_speed_fast).setEnabled(false);
...
//    }
    ...
    private void goToSelectDeviceActivity() {
        ...
        Intent intent = new Intent(SettingPatchActivity.this, SelectDeviceActivity.class);
    ...
    private void setHotKey() {
        boolean isSetHotKey = PreferencesUtil.getInstance(SettingPatchActivity.this).getIsSetHotKey();
        LogUtil.d(TAG, "setHotKey() >> isSetHotKey: " + isSetHotKey);
        ...
        if (!isSetHotKey) {
            ...
            PreferencesUtil.getInstance(SettingPatchActivity.this).setBkeyDouble(hashMap);
            PreferencesUtil.getInstance(SettingPatchActivity.this).setBkeyLong(hashMap);
            PreferencesUtil.getInstance(SettingPatchActivity.this).setCkeyDouble(hashMap);
            PreferencesUtil.getInstance(SettingPatchActivity.this).setCkeyLong(hashMap);

            PreferencesUtil.getInstance(SettingPatchActivity.this).setIsSetHotKey(true);
        }

        isSetHotKey = PreferencesUtil.getInstance(SettingPatchActivity.this).getIsSetHotKey();
        LogUtil.d(TAG, "setHotKey() >> isSetHotKey: " + isSetHotKey);
        ...
        if (isSetHotKey) {
            ...
            //
            ////////////////////////////////////////////////////////////////////////////////////
            HashMap<String, String> hmBKeyDouble = PreferencesUtil.getInstance(SettingPatchActivity.this).getBkeyDouble();
            LogUtil.d(TAG, "setHotKey() >> hmBKeyDouble: " + hmBKeyDouble);
            ...
            //
            ////////////////////////////////////////////////////////////////////////////////////
            HashMap<String, String> hmBKeyLong = PreferencesUtil.getInstance(SettingPatchActivity.this).getBkeyLong();
            LogUtil.d(TAG, "setHotKey() >> hmBKeyLong: " + hmBKeyLong);
            ...
            //
            ////////////////////////////////////////////////////////////////////////////////////
            HashMap<String, String> hmCKeyDouble = PreferencesUtil.getInstance(SettingPatchActivity.this).getCkeyDouble();
            LogUtil.d(TAG, "setHotKey() >> hmCKeyDouble: " + hmCKeyDouble);
            ...
            //
            ////////////////////////////////////////////////////////////////////////////////////
            HashMap<String, String> hmCKeyLong = PreferencesUtil.getInstance(SettingPatchActivity.this).getCkeyLong();
            LogUtil.d(TAG, "setHotKey() >> hmCKeyLong: " + hmCKeyLong);
